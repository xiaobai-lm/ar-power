      ...
      <a-row :gutter="20">
        ...
        >
          <a-card
            ...
            header-style="background: linear-gradient(to top, #6c7fff, #3a54ff)"
            bordered="false"
            body-style="border: 1px solid #3a54ff;border-top: unset;"
          >
            <template #title>
              <span>办公室2楼</span>
              <a-button @click="historyClick"> <icon-close /> 历史数据</a-button>
            </template>
            <a-row :gutter="6">
              <a-col :span="24">
          ...
          <a-modal v-model:visible="visible" @ok="handleOk" @cancel="handleCancel">
            ...
            <Child :item="parentMsg" :data="dataList" v-show="modalShow" />
            <a-table
...
const dataList = ref(["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"]);
