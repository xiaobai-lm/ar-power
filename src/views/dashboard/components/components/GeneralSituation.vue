          ...
          <a-row>
              ...
              <a-row :gutter="6">
                ...
                >
                  <div
                    ...
                    "
                  >
                    <img v-show="consumeElectricity.isShow" alt="" src="" />
            ...
            <a-col :span="12">
              <a-row>
                <a-col
                  :span="11"
                  style="background-color: #232324; margin-left: 10px"
                >
          ...
          <a-row :gutter="10">
            ...
            >
              <div
                ...
                "
              >
                <img v-show="generateElectricity.isShow" alt="" src="" />
                ...
                <div style="height: 80px">
                  <div
                    style="margin-bottom: 20px; color: #6c7c8b; font-size: 14px"
                  >
