<template>
  <div class="container">
    <a-row :gutter="10" class="container-condition">
      <a-col
      ...
      >
        <div class="container-condition-first-data">
          <div class="container-condition-first-top">
            <span class="container-condition-first-top-left">{{
              item.title
            }}</span>
            <span class="container-condition-first-top-right">{{
              item.titleData
            }}</span>
            <span><img alt="" src="" /></span>
          </div>
          <div class="container-condition-first-bottom">{{
            item.condition
          }}</div>
        </div>
      </a-col>
      ...
      <a-col
        v-for="(thirdItem, thirdIndex) in third"
        :key="thirdIndex"
        :span="2"
      >
        <div class="container-condition-third">
          <img alt="" src="" />
          <div class="container-condition-third-AlarmType">{{
            thirdItem.AlarmType
          }}</div>
    ...
    <a-row :gutter="10" class="container-generateElectricity">
      <a-col :span="4">
        <div
    ...
    <a-row :gutter="10" class="container-statusMessages">
      ...
      <a-col :span="8" class="container-statusMessages-center">
        <a-card style="height: 350px">
          ...
          <a-list :bordered="false">
            <a-list-item
              v-for="(listData, listIndex) in listList"
              :key="listIndex"
    ...
    <a-row :gutter="10" class="container-last">
      <a-col :span="12">
  ...
  * {
  ...
  .container {
    ...
    &-condition {
      ...
      &-first-data:nth-child(2n + 1) {
        background: linear-gradient(135deg, #2f4d92, #181765);
      }

      &-first-data:nth-child(2n) {
