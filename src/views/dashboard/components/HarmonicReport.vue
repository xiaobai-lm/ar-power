<template>
    <div class="container">
        <div class="container-select">
            ...
            谐波次数：<a-select :style="{ width: '300px' }" multiple :scrollbar="scrollbar" :max-tag-count="2">
                <a-option>Beijing</a-option>
                <a-option>Shanghai</a-option>
                <a-option>Guangzhou</a-option>
            ...
            <a-date-picker v-model="value" v-if="checkValue === '1'" style="width: 200px;" />
            <a-month-picker v-model="value" v-else style="width: 200px;" />
        ...
        <a-card v-show="isShowTwo">
            <a-table v-if="checkValue === '1'" :columns="columns" :data="data" :bordered="{ cell: true }"></a-table>
            <a-table v-else :columns="columnsTwo" :data="dataTwo" :bordered="{ cell: true }"></a-table>
        </a-card>
    </div>
</template>
