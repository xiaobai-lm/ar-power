<template>
  <div class="container">
    <a-tabs class="tabsList" type="card-gutter">
      <a-tab-pane key="1" title="任务列表">
        <div style="margin-bottom: 20px">
          ...
          <span style="color: rgb(var(--gray-10))"
            >已选{{ selectedKeys.length }} 个任务</span
          >
          <a-input-search
            :style="{ width: '320px', float: 'right', marginRight: '10px' }"
            placeholder="搜索名称或目标"
          />
        </div>
        <a-modal
          ...
          @ok="handleOk"
        >
          <template #title> 新建定时任务</template>
          <div class="Amodal">
              ...
              >
                <a-tabs type="card">
                  <a-tab-pane key="1" title="变量">
                    ...
                    >
                      <a-radio-group
                        v-if="checkedValue === '1' ? true : false"
                        v-model="switchValue"
                      >
      ...
      <a-tab-pane key="2" title="控制历史">
        <span class="historySpan">定时任务：</span>
        <a-select :style="{ width: '200px' }"></a-select>
        <span class="historySpan"> 场景： </span>
        <a-select :style="{ width: '200px' }"></a-select>
        <span class="historySpan"> 设备：</span>
        <a-select :style="{ width: '200px' }"></a-select>
        <span class="historySpan">变量：</span>
        <a-select :style="{ width: '200px' }"></a-select>
        <span class="historySpan">执行时间：</span>
