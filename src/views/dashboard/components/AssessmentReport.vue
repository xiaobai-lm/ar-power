<template>
  <div class="container">
    <a-tabs v-model:active-key="activeKey" class="tabsList" type="card-gutter">
      <a-tab-pane key="1" title="实时评分">
        ...
        <a-row :gutter="20">
          <a-col :span="6" style="position: relative">
            <a-card style="margin: 0 auto" title="评分">
              <div id="radarChart"></div>
              <div id="radarChartValue" :style="radarStyle">
                {{ achievement }}
              </div>
            </a-card>
            <a-card style="margin-top: 20px" title="回路统计">
      ...
      <a-tab-pane key="2" title="单回路监测">
        ...
        <a-row :gutter="20">
          <a-col :span="8">
            ...
            <a-card style="margin: 10px 0" title="电压 额定电压10.5V">
