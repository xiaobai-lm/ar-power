<template>
  <div class="container">
    <div class="container-header">
      <span style="font-style: italic; padding: 20px; font-size: 16px"
        >空调列表</span
      >
      <a-select
        v-model="value"
      ...
      <div class="container-body-content">
        ...
        >
          ...
          >
            ...
            <span
              :style="value.style"
              style="font-size: 16px; font-family: 楷体"
              >{{ value.data2 }}</span
            >
          </div>
        </div>
...
<script lang="ts" setup>
  ...
  // 柱状图
  const bar = ref([
    120, 200, 150, 80, 70, 110, 130, 20, 30, 30, 30, 30, 30, 30, 50, 60, 70, 70,
    70, 70, 70, 90, 100,
  ]);
  // 折线图
  const line = ref([
  ...
  const handleChange2 = (key) => {
    ...
    if (key === '1') {
      bar.value = [
        120, 200, 150, 80, 70, 110, 130, 20, 30, 30, 30, 30, 30, 30, 50, 60, 70,
        70, 70, 70, 70, 90, 100,
      ];
      ec.setOption({
        series: [
