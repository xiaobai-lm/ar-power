  ...
  <div class="container" v-show="isShowAll">
    <div class="container-header">
      <a-row justify="space-between">
        <a-col :span="12">
          <a-select :style="{ width: '320px' }" :default-value="'Beijing'" placeholder="Please select ...">
        ...
        <a-col :span="12" style="text-align: right">
          ...
          <a-input-search :style="{ width: '160px', margin: '0 10px' }" placeholder="搜索名称" allow-clear />
        </a-col>
      </a-row>

      <a-modal v-model:visible="visible" @before-ok="beforeOk" @ok="handleOk" @cancel="handleCancel" :align-center="false"
        :top="200" width="500px">
        ...
        <div class="container-header-switchOn-modalOn">
          ...
          <a-input-password :style="{ width: '320px', margin: '10px 0' }" :default-value="iptValue" placeholder="请输入登录密码"
      ...
      <a-modal v-model:visible="visibleTwo" @before-ok="beforeOkTwo" @ok="handleOkTwo" @cancel="handleCancelTwo"
        :align-center="false" :top="200" width="500px">
        <template #title> 远程控制 </template>
        <div class="container-header-switchOn-modalOff">
          ...
          <a-input-password :style="{ width: '320px', margin: '10px 0' }" :default-value="iptValueTwo"
            placeholder="请输入登录密码" :invisible-button="false" />
    ...
    <div class="container-main" v-show="isShow">
      <a-row :gutter="10">
        <a-col :span="6" v-for="(item, index) in dataList" :key="index" @click="cardClick(index)">
              ...
              <a-col :span="16">
                <div class="container-main-body-right">
                  ...
                  <div>
                    ...
                    <span class="container-main-body-right-value">{{ item.drainCurrentValue }}{{ list.MA }}</span>
                  </div>
                  <div>
                    <span class="container-main-body-right-type">{{
    ...
    <div class="container-table" v-show="isShowTwo">
      <a-table :columns="columns" :data="data" :pagination="pagination" :row-selection="rowSelection"
        :bordered="{ wrapper: true, cell: true }" />
      <a-pagination class="container-table-pagination" :page-size="pageSize" :total="data.length" show-total
        show-page-size @page-size-change="pagChange" />
    </div>
  </div>

  <div class="content" v-show="isShowAllTwo" v-for="(content, contentIndex) in dataList" :key="contentIndex">
      ...
      <a-card class="content-main-firstCard">
        <a-row>
          ...
          <a-col :span="2" style="border-left: 1px solid white; height: 120px">
            <a-button style="margin: 20px 0 20px 10px" @click="handleClick" class="container-header-switchOn">
              <template #icon> <icon-shrink /> </template>
              分闸
            </a-button>
            <a-button @click="handleClickTwo" class="container-header-switchOff">
      ...
      <a-row :gutter="10" class="content-main-second">
        <a-col :span="8">
          <a-card class="content-main-second-card">
            ...
            <a-row>
              <a-col :span="12" v-for="(realTimeData, DataIndex) in realTimeDataList" :key="DataIndex">
        ...
        <a-col :span="16">
          <a-card style="height: 400px; width: 100%">
            ...
            <a-tabs default-active-key="1">
              <a-tab-pane :title="realTimeData.type" v-for="(realTimeData, DataIndex) in realTimeDataList"
                :key="DataIndex">
              </a-tab-pane>
            </a-tabs>
      ...
      <a-row :gutter="10" style="margin-top: 20px">
        <a-col :span="8">
          <a-card title="控制记录" style="height: 400px; padding: 10px">
            <a-table :columns="ControlRecord" :data="ControlRecordData" :bordered="{ wrapper: true, cell: true }">
            </a-table>
          </a-card>
        </a-col>
        <a-col :span="16">
...
// card值
const cardClick = (index: any) => {
  console.log(index);
  isShowAll.value = false;
  isShowAllTwo.value = true;
  if (index === 0) {
    dataList.value.splice(1, 1)
  }else{
