<template>
  <div v-show="isShowAll" class="container">
    <div class="container-header">
      <a-row justify="space-between">
        <a-col :span="12">
          ...
          <a-checkbox :model-value="checkBox" @change="handleChange"
            >全选
          </a-checkbox>
          <a-button class="container-header-switchOn" @click="handleClick">
            <template #icon>
              <icon-shrink />
            </template>
            分闸
          </a-button>
          <a-button class="container-header-switchOff" @click="handleClickTwo">
            <template #icon>
              <icon-expand />
            </template>
            合闸
      ...
      >
        ...
        <div class="container-header-switchOn-modalOn">
          ...
          <div class="container-header-switchOn-modalOn-passWord"
            >请输入登录密码：
          </div>
          <a-input-password
      ...
      >
        ...
        <div class="container-header-switchOn-modalOff">
          ...
          <div class="container-header-switchOn-modalOff-passWord"
            >请输入登录密码：
          </div>
          <a-input-password
    ...
    <div v-show="isShow" class="container-main">
      <a-row :gutter="10">
        <a-col
        ...
        >
          <a-card :body-style="item.bodyStyle" :header-style="item.headerStyle">
            <template #title>
    ...
    <div v-show="isShowTwo" class="container-table">
      <a-table
  ...
  >
    ...
    <div class="content-main">
      <a-card class="content-main-firstCard">
        <a-row>
          <a-col :span="3" class="content-main-firstCard-left">
            <img
              :src="content.circuitBreaker"
              class="content-main-firstCard-left-img"
            />
          </a-col>
          <a-col :span="4" class="content-main-firstCard-left2">
            <div class="content-main-firstCard-left2-title">
              {{ content.title }}
              <span :style="content.GateStateStyle">{{
                content.GateState
              }}</span>
            </div>
          ...
          <a-col :span="2" style="border-left: 1px solid white; height: 120px">
            ...
            <a-button
              class="container-header-switchOff"
      ...
      <a-row :gutter="10" style="margin-top: 20px">
        <a-col :span="8">
          <a-card style="height: 400px; padding: 10px" title="控制记录">
            <a-table
              :bordered="{ wrapper: true, cell: true }"
        ...
        <a-col :span="16">
          <a-card style="height: 400px; padding: 10px" title="告警统计">
...
<script lang="ts" setup>
  ...
  const dataList = ref([
    {
      ...
      GateState: '合闸',
      GateStateStyle:
        'background-color: #e00202;padding: 6px 8px;font-size: 14px;',
  ...
  setTimeout(() => {
    ...
    const wringEcharts = echarts.init(
      document.getElementById('wringEcharts'),
      null,
      {
        height: 280,
      }
