  ...
  <div class="container">
    <a-layout class="container-layout">
      ...
      <a-layout-content class="container-layout-content">
        ...
        <a-tabs v-else auto-switch type="card-gutter">
          <a-tab-pane key="1" title="概况">
            <GeneralSituation />
          </a-tab-pane>
          <a-tab-pane key="2" title="实时数据">
            <RealData />
          </a-tab-pane>
          <a-tab-pane key="3" title="事件记录">
            <Incident />
          </a-tab-pane>
          <a-tab-pane key="4" title="运行状态统计">
            <RunningState />
          </a-tab-pane>
          <a-tab-pane key="5" title="历史趋势">
            <HistoricalTrend />
          </a-tab-pane>
          <a-tab-pane key="6" title="数据报表">
            <DataReport />
          </a-tab-pane>
        </a-tabs>
      </a-layout-content>
