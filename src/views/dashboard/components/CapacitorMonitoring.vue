<template>
  <div class="container">
    ...
    <div class="container-body" v-show="isShow">
      <a-row :gutter="20">
        <a-col :xxl="4" :xl="5" :lg="6" :md="8" v-for="(item, index) in cardList" :key="index" class="container-body-col">
          <a-card class="container-body-col-card"
            :header-style="{ background: 'linear-gradient(to top, #6c7fff, #3a54ff)' }" :bordered="false"
            ...
            <a-row :gutter="6">
              ...
              <a-col v-for="(List, index2) in item.children1" :key="index2" :span="item.span">
                <a-list :bordered="false" fixedSize="true" style="height: 120px">
                  <template #header>
                    <span style="font-size: 12px; padding: 0">{{
                      List.CableTemperatureTitle
                    }}</span>
                  </template>
                  <a-list-item v-for="(List2, index3) in List.children2" :key="index3">
          ...
          <a-modal v-model:visible="item.visible" @ok="handleOk" @cancel="handleCancel">
            ...
            <Child :item="parentMsg" :data="dataList" :myChart="myChartSon" v-if="modalShow" />
            <a-table :columns="modalColumns" :data="modalData" :bordered="{ wrapper: true, cell: true }"
              v-if="modalShowTwo" />
          </a-modal>
        </a-col>
      </a-row>
    ...
    <div class="container-main" v-show="isShowTwo">
      <a-table :columns="columns" :data="data" :bordered="{ wrapper: true, cell: true }">
