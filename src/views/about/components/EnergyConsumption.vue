<template>
    <div class="container">
        <div class="container-header">
            <a-radio-group v-model="radioValue" class="container-header-first" @change="handleChange">
                <a-radio value="1">
            ...
            <a-date-picker class="datePicker" v-if="radioValue === '2'" v-model="dateValue" />
            <a-month-picker class="datePicker" v-else-if="radioValue === '3'" v-model="dateValue" />
            <a-year-picker class="datePicker" v-else-if="radioValue === '4'" v-model="dateValue" />

            <a-radio-group v-if="radioValue === '1'" v-model="radioValueTwo" @change="radioValueChange"
            ...
            <a-radio-group v-else v-model="radioValueThree" class="container-header-right">
                <a-radio value="1">
                    <template #radio="{ checked }">
                        <a-tag :checked="checked" checkable>用量</a-tag>
                    </template>
        ...
        <div class="container-content" v-show="contentValue">
                ...
                <a-row>
                    <a-col :span="4">
                        ...
                        <a-card style="margin-top: 10px;">
                            ...
                            <div style="font-size: 25px;text-align: center;margin: 0 0 20px 0;">0.747</div>
            ...
            <div class="container-content-bottom">
                <a-row :gutter="10">
                    <a-col :span="6" v-for="(item, index) in bottomList" :key="index">
                        <!-- <a-col :span="6" style="background-color:var(--color-bg-2);padding:10px;border: 1px solid #484849;"> -->
                        <div style="background-color:var(--color-bg-2);padding:10px;border: 1px solid #484849;">
        ...
        <div class="container-contentTwo" v-show="contentTwoValue">
            <a-row :gutter="10">
                <a-col :span="6">
                    <a-card title="当日总能耗">
                        ...
                        <a-divider></a-divider>
                        <div style="font-size: 16px;text-align: center;">昨日同期 0.914 <span style="color: red;">46.52%
                                <icon-caret-up /> </span></div>
                    </a-card>
                ...
                <a-col :span="18">
                    <a-card title="当日能源同比/环比" style="height: 400px;">
                        <a-table :columns="columns" :data="data" :bordered="{ cell: true }"></a-table>
                    </a-card>
...
const radioValueChange = () => {
    if (radioValueTwo.value === "3" || radioValueTwo.value === "4" || radioValueTwo.value === "5") {
        disabled.value = true
    } else {
...
onMounted(() => {
    const cardImgListTop = echarts.init(document.getElementById("cardImgListTop"), null, {
        height: 280
    })
    ...
    const cardImgListBottom = echarts.init(document.getElementById("cardImgListBottom"), null, {
        height: 280
    })
    ...
    nextTick(() => {
        const contentTwoLeftBottom = echarts.init(document.getElementById("contentTwoLeftBottom"), null, {
            height: 380, width: 388
        })
        ...
        const contentTwoRightBottom = echarts.init(document.getElementById("contentTwoRightBottom"), null, {
