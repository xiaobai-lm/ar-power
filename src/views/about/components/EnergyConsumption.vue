<template>
  <div class="container">
    ...
    <div v-show="contentValue" class="container-content">
      <a-card class="container-content-firstCard" title="当日总能耗趋势">
        <template #extra>
          <div>
      ...
      <a-card class="container-content-secondCard" title="当月总能耗趋势">
        <template #extra>
          <div>
    ...
    <div v-show="contentTwoValue" class="container-contentTwo">
      <a-row :gutter="10">
        <a-col :span="6">
          ...
          <a-card style="margin-top: 10px" title="当日用能能源占比">
            <div id="contentTwoLeftBottom"></div>
          </a-card>
        </a-col>
        <a-col :span="18">
          <a-card style="height: 400px" title="当日能源同比/环比">
            <a-table
              :bordered="{ cell: true }"
              :columns="columns"
              :data="data"
          ...
          <a-card style="margin-top: 10px" title="当日能源趋势">
